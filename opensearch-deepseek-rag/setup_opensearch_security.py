...
'''
Maps the backend roles to create connectors for the authenticated user, and for
the helper lambda generated by the integration template for the embedding model
onto the ml_full_access OpenSearch role. You need these OpenSearch permissions
